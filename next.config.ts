...
const securityHeaders = [
  ...
  // Content Security Policy — allow embeds from streaming providers
  {
    ...
    value: [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https: https://api.themoviedb.org https://api.real-debrid.com https://*.real-debrid.com https://*.stream.real-debrid.com https://*.real-debrid.cloud https://*.download.real-debrid.cloud https://*.supabase.co https://api.opensubtitles.com https://api.subdl.com https://*.strem.io https://*.clerk.accounts.dev https://*.clerk.com https://clerk-telemetry.com https://*.streamruby.net",
